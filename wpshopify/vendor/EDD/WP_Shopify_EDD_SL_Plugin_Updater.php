...
class WP_Shopify_EDD_SL_Plugin_Updater
{
    ...
    public function __construct($_api_url, $_plugin_file, $_api_data = null)
    {
        ...
        $this->cache_key =
            ...
            md5(
                serialize(
                    $this->slug . $this->api_data['license'] . $this->beta
                )
            );
    ...
    public function show_changelog()
    {
        ...
        if (false === $version_info) {
            ...
            if (!empty($version_info) && isset($version_info->sections)) {
                $version_info->sections = maybe_unserialize(
                    $version_info->sections
                );
            } else {
                $version_info = false;
    ...
    {
        if (
            defined('WP_SHOPIFY_FORCE_UPDATES') &&
            WP_SHOPIFY_FORCE_UPDATES === true
        ) {
            return false;
        }
