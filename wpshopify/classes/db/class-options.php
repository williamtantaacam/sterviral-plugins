...
class Options extends \WP_Shopify\DB
{
    ...
    {
        $this->table_name_suffix = WP_SHOPIFY_TABLE_NAME_OPTIONS;
  ...
  */
    ...
    {
        return ['id', 'option_id', 'product_id', 'position'];
    }
	...
	*/
    public function get_options_from_post_id($postID = null)
    {
        ...
        $query =
            ...
            " as options ON products.product_id = options.product_id WHERE products.post_id = %d";
