...
class Shop extends \WP_Shopify\DB
{
   ...
   */
    ...
    {
        return ['id', 'latitude', 'longitude', 'primary_location_id'];
    }
    ...
    public function get_column_defaults()
    {
        return [
            ...
            'google_apps_login_enabled' =>
                $this->default_google_apps_login_enabled,
            ...
            'requires_extra_payments_agreement' =>
                $this->default_requires_extra_payments_agreement,
            ...
            'eligible_for_card_reader_giveaway' =>
                $this->default_eligible_for_card_reader_giveaway,
