...
class Settings_General extends \WP_Shopify\DB
{
    ...
    public $default_inline_cart_counter_text_color;
    ...
    public function __construct()
    {
        ...
        $this->default_webhooks = Utils::convert_to_https_url(
            Utils::get_site_url()
        );
        $this->default_plugin_version = WP_SHOPIFY_NEW_PLUGIN_VERSION;
        $this->default_compatibility_plugin_version = WP_SHOPIFY_COMPATIBILITY_PLUGIN_VERSION;
        $this->default_plugin_author = WP_SHOPIFY_NEW_PLUGIN_AUTHOR;
        $this->default_plugin_textdomain = 'wpshopify';
        ...
        $this->default_products_link_to = WP_SHOPIFY_DEFAULT_PRODUCTS_LINK_TO;
        $this->default_products_link_target = WP_SHOPIFY_DEFAULT_PRODUCTS_LINK_TARGET;
        ...
        $this->default_inline_cart_counter_text_color = WP_SHOPIFY_DEFAULT_INLINE_CART_COUNTER_TEXT_COLOR;
        ...
        $this->default_cart_conditional_fixed_tab_loading = WP_SHOPIFY_DEFAULT_CART_CONDITIONAL_FIXED_TAB_LOADING;
        ...
        $this->default_page_products = WP_SHOPIFY_DEFAULT_PAGE_PRODUCTS;
        $this->default_page_collections = WP_SHOPIFY_DEFAULT_PAGE_COLLECTIONS;

        $this->default_page_products_default = '';
        $this->default_page_collections_default = '';

        $this->default_variant_style = WP_SHOPIFY_DEFAULT_VARIANT_STYLE;
    ...
    public function get_columns()
    {
        return [
            ...
            'cart_icon_color' => '%s',
            'inline_cart_counter_text_color' => '%s',
   ...
   */
    ...
    public function get_column_defaults($blog_id = false)
    {
        return [
            ...
            'inline_cart_counter_text_color' =>
                $this->default_inline_cart_counter_text_color,
            ...
            'cart_counter_fixed_color' =>
                $this->default_cart_counter_fixed_color,
            'cart_fixed_background_color' =>
                $this->default_cart_fixed_background_color,
    ...
    {
        return $this->update_column_single(
            ['plugin_version' => $new_version_number],
            ['id' => $this->settings_id()]
        );
    }
    ...
    public function create_table_query($table_name = false)
    {
        ...
        return "CREATE TABLE $table_name (
         ...
         inline_cart_counter_text_color varchar(100) NOT NULL DEFAULT '{$this->default_inline_cart_counter_text_color}',
