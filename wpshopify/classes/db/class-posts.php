...
class Posts extends \WP_Shopify\DB
{
	...
	*/
    public function delete_all_posts()
    {
        ...
        ] = $this->delete_posts_by_type(WP_SHOPIFY_PRODUCTS_POST_TYPE_SLUG);
        $results[
            WP_SHOPIFY_COLLECTIONS_POST_TYPE_SLUG
        ] = $this->delete_posts_by_type(WP_SHOPIFY_COLLECTIONS_POST_TYPE_SLUG);
	...
	*/
    public function get_from_post_name_query($table_name)
    {
        return 'SELECT items.* FROM ' .
            $table_name .
            ' as items WHERE items.post_name = %s';
    }
	...
	*/
    public function get_from_post_name_query_prepared($post_name, $table_name)
    {
        ...
        return $wpdb->prepare(
            $this->get_from_post_name_query($table_name),
            $post_name
        );
    }
	...
	*/
    public function get_from_post_name($table_name = false, $post_name = false)
    {
        ...
        return $wpdb->get_row(
            $this->get_from_post_name_query_prepared($post_name, $table_name)
        );
    }
}
