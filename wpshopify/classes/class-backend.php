...
class Backend
{
    ...
    public function admin_scripts()
    {
        if ($this->should_load_js() && !$this->is_wizard_page()) {
            ...
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.49e1a3.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/admin.49e1a3.min.js';
   ...
   */
    ...
    public function wpshopify_blocks_assets()
    {
        if (is_admin()) {
            ...
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.49e1a3.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/blocks.49e1a3.min.js';
    ...
    public function wpshopify_wizard_assets()
    {
        if ($this->is_wizard_page()) {
            ...
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.49e1a3.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/wizard.49e1a3.min.js';
